...
def get_elevation_from_gee(csv_file = r"C:\Users\muzah\OneDrive - Louisiana State University\Spring 2025\GEOG  4057\Project\Project 2\boundary.csv",
                           shapefile = r"C:\Users\muzah\OneDrive - Louisiana State University\Spring 2025\GEOG  4057\Project\Project 2\boundary.shp",
                           factoryCode = 32119):
    # earth engine image access
    ee.Authenticate()
    ee.Initialize(project='geog4057spring2025')
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 3:
        ...
        csv_file = r"C:\Users\muzah\OneDrive - Louisiana State University\Spring 2025\GEOG  4057\Project\Project 2\boundary.csv"
        shapefile = r"C:\Users\muzah\OneDrive - Louisiana State University\Spring 2025\GEOG  4057\Project\Project 2\boundary4.shp"
        factoryCode = 32119
